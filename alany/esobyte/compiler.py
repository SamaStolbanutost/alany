...
def run(index: int, code: List[str], stack: LifoQueue, memory: Dict[str, Any],
        fun: bool, funs: Dict[str, int]):
...
def run_code(code: str):
    ...
    while index < len(code):
        ...
        stack, memory, index, fun, funs = run(index, code, stack, memory, fun,
                                              funs)
        index += 1
        if st == 2 and fun == 0:
